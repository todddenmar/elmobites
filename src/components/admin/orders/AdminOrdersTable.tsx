...
import { TOrderTableItem } from "@/typings";
  ...
  const columns: ColumnDef<TOrderTableItem>[] = [
    {
      ...
      cell: ({ row }) => {
        ...
        return <div className="px-3 capitalize">Order#:{orderID}</div>;
      },
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="px-3 capitalize">{row.getValue("status")}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <ViewOrderDialog order={orderData} />;
      },
    },
  ];
