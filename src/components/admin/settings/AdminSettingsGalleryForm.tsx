...
import ProductMediaDropzone from "../products/ProductMediaDropzone";
type AdminSettingsGalleryFormProps = {
  previousImages?: TMediaFile[];
  onChange: (val: TFilePreview[]) => void;
};
function AdminSettingsGalleryForm({
  previousImages,
  onChange,
}: AdminSettingsGalleryFormProps) {
...
export default AdminSettingsGalleryForm;
