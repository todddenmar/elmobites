...
export function AdminEmployeeTable({ employees }: AdminEmployeeTableProps) {
  ...
  const columns: ColumnDef<TEmployeeTableItem>[] = [
    {
      ...
      cell: ({ row }) => {
        const positionData: TPosition = row.getValue("position");
        return (
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return (
          <div className="px-3 capitalize flex items-center gap-4">{name}</div>
        );
      },
    },
    {
