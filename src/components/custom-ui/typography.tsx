...
export function TypographyH2({ children }: TTypographyProps) {
  return (
    <h2 className="scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 font-main">
      {children}
    </h2>
  );
}
...
export function TypographyH3({ children }: TTypographyProps) {
  return (
    <h2 className="scroll-m-20 text-2xl font-semibold tracking-tight font-main">
      {children}
    </h2>
  );
}
export function TypographyH4({ children }: TTypographyProps) {
  return (
    <h4 className="scroll-m-20 text-xl font-semibold tracking-tight font-main">
      {children}
    </h4>
  );
}
